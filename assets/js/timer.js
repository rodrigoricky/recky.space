 ...
 */
function tweet () {
  var win = window.open('https://twitter.com/intent/tweet?url=http%3A%2F%recky.tech&text=I%20got%20ratelimited%20for%20' + formatDiffernce(2) + '%20seconds!&related=deansheather1&hashtags=b1nzy,ratelimited', '_blank');
  win.focus();
...
function toot () {
  ...
  var win = window.open('https://' + window.mastodonInstance + '/share?text=I+got+ratelimited+for+' + formatDiffernce(2) + '+seconds!+++https://recky.tech', '_blank');
